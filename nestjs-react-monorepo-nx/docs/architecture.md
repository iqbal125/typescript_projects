...
- packages/server/db/: Drizzle ORM schema and DB tooling.
...
Shared packages:
- @org/server-db: Database schema, entities, and migration tooling.
- @org/shared-types: Reusable DTO and validation contracts.
- @org/shared-utils: Generic utility helpers.
...
- frontend -> @org/shared-utils
- backend -> @org/server-db
- backend -> @org/shared-types
- backend -> @org/shared-utils
